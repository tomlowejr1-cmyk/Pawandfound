  ...
  head: () => ({
    meta: [
      { title: "Adopt a Pet — Paw & Found ❤️" },
      {
        name: "description",
        content:
          "Find your new best friend through Voorhees Animal Orphanage. Browse adoptable dogs and cats, learn about the adoption process, and give a shelter pet a loving home.",
      },
      { property: "og:title", content: "Adopt a Pet — Paw & Found ❤️" },
      {
        property: "og:description",
        content: "Browse adoptable dogs and cats from Voorhees Animal Orphanage. Give a shelter pet their forever home.",
      },
    ...
    <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="text-center">
        ...
        <p className="mt-3 text-[#6B7280] max-w-2xl mx-auto">
          ...
          dedicated to finding loving homes for dogs and cats in need.
        </p>
      </div>

      {/* Shelter Info Card */}
      <div className="mt-10 rounded-2xl border-2 border-[#2A9D8F] bg-gradient-to-br from-[#E8F8F5] to-white p-6 sm:p-8">
        <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start">
          <div className="flex h-20 w-20 flex-shrink-0 items-center justify-center rounded-full bg-[#2A9D8F]/10 text-5xl">
            🐕
          </div>
          <div>
            ...
            <p className="mt-2 text-sm text-[#6B7280]">
              Located in Voorhees, New Jersey, this no-kill shelter has been serving the community
              for decades. They provide medical care, spay/neuter services, and behavioral support
              for every animal in their care — all while working tirelessly to match each pet with
              the right family.
            </p>
