...
echo "[1/4] generate blog data from markdown"
node build-blog-data.cjs
...
{ "runtime": "@vercel/node@3.2.24", "handler": "index.mjs", "launcherType": "Nodejs", "supportsResponseStreaming": true }
JSON
